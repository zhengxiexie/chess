...
namespace idl
{
	...
	int mcp_servlet_trunk::dispatch(int64_t, const char * function, const mc_pack_t * param, mc_pack_t * result)
	{
		...
		if (0 == strcmp(function, "get_qp_top_activity"))
		{
			mcp_get_qp_top_activity_params param_idl(getMempool());
			if (param != 0)
			{
				param_idl.load(param);
			}
			mcp_get_qp_top_activity_response response_idl(getMempool());
			if (get_qp_top_activity(param_idl, response_idl))
			{
				CWARNING_LOG("%s", "user function error");
				return -1;
			}
		...
		if (0 == strcmp(function, "get_qp_rule"))
		{
			mcp_get_qp_rule_params param_idl(getMempool());
			if (param != 0)
			{
				param_idl.load(param);
			}
			mcp_get_qp_rule_response response_idl(getMempool());
			if (get_qp_rule(param_idl, response_idl))
			{
				CWARNING_LOG("%s", "user function error");
				return -1;
			}
		...
		if (0 == strcmp(function, "get_qp_basic_info"))
		{
			mcp_get_qp_basic_info_params param_idl(getMempool());
			if (param != 0)
			{
				param_idl.load(param);
			}
			mcp_get_qp_basic_info_response response_idl(getMempool());
			if (get_qp_basic_info(param_idl, response_idl))
			{
				CWARNING_LOG("%s", "user function error");
				return -1;
			}
		...
		if (0 == strcmp(function, "test_redis"))
		{
			mcp_test_redis_params param_idl(getMempool());
			if (param != 0)
			{
				param_idl.load(param);
			}
			mcp_test_redis_response response_idl(getMempool());
			if (test_redis(param_idl, response_idl))
			{
				CWARNING_LOG("%s", "user function error");
				return -1;
			}
		...
		{
			mcp_use_exchange_code_params param_idl(getMempool());
			if (param != 0)
			{
				param_idl.load(param);
			}
			mcp_use_exchange_code_response response_idl(getMempool());
